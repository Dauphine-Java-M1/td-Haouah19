package fr.dauphine.ja.haouiliahmed.iterables.test;
import fr.dauphine.ja.haouiliahmed.iterables.src.Mult;
import fr.dauphine.ja.haouiliahmed.iterables.src.Panel;
import java.util.*;
import org.junit.*;
